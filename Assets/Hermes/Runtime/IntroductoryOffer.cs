namespace Hermes {
    ...
    public class IntroductoryOffer {
        ...
        public IntroductoryOffer(string localizedTitle, string localizedDescription, string iSOCurrencyCode,
            float regularPrice, string localizedRegularPriceString, UnitType regularUnit, int regularNumberOfUnit,
            bool isIntroductory, float introductoryPrice, string introductoryPriceLocale,
            string localizedIntroductoryPriceString, UnitType introductoryUnit, int introductoryNumberOfPeriods,
            int introductoryNumberOfUnits, bool isFreeTrial, UnitType freeTrialUnit, int freeTrialNumberOfPeriods,
            int freeTrialNumberOfUnits, string originalJson) {
